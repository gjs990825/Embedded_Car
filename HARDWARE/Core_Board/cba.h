...
#define Action_S2() LEDDispaly_ShowDistance(Ultrasonic_GetAverage(20)) // LEDDispaly_ShowDistance(Ultrasonic_Task(10)) //Infrared_Send(H_1, 4)  //调光
#define Action_S3() BarrierGate_Task() //SYN7318_Test() // SYN7318_Test()
